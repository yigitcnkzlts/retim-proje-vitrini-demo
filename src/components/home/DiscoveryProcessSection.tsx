...
import type { DiscoverySectionContent, ProblemsSectionContent } from "@/lib/cms/home-content";
import { mergeDiscoveryStepsForDisplay } from "@/lib/cms/home-content";
...
export default function DiscoveryProcessSection({ problemsSection, discoverySection }: Props) {
  const steps = mergeDiscoveryStepsForDisplay(discoverySection);
  const report = discoverySection.report;

  return (
    <>
      <section className="building-problems-section border-b border-[#e8dfd0] bg-[#f7f3ec] py-14 md:py-20">
        <div className="container-main">
          <BuildingProblemsDiagram section={problemsSection} />
        </div>
      </section>
