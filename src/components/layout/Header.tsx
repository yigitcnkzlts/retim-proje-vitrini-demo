        ...
        <div className="flex h-[4.25rem] items-center justify-between gap-3 sm:h-[4.5rem] lg:gap-4">
          ...
          <div className="hidden shrink-0 items-center gap-2 lg:flex xl:gap-2.5">
            <a
              ...
              className="header-phone hidden items-center gap-1.5 whitespace-nowrap text-sm font-semibold text-retim-navy transition-colors hover:text-retim-orange xl:inline-flex"
            >
              <svg className="h-4 w-4 text-retim-orange" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden>
                <path
                  strokeLinecap="round"
